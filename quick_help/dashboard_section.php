...
<?php 
$offering1 = strip_tags($_GET['data_type']);
//replace hypen with space
$offering = str_replace('-', ' ', $offering1);

echo "<h3><center>$offering Categories</center></h3>";
?>
...
//url: 'post_loadmore_hotspots.php',
 ...
 var postData ="<?php echo $offering1; ?>";
        postRow = postRow + 5;
...
22
 ...
 "where": "{'.$offering1_type_field.'.CT.'.$offering1.'}",
