...
$request_userid= intval($userid_sess_data);
...
if($user_rec_count == 0){
echo "<div style='background:red;color:white;padding:10px;'>You have no Record Yet..</div>";
exit();
}
...
<h4><center>Your Posts List</center></h4>
...
if($total_count == 0){
echo "<div style='background:red;color:white;padding:10px;'>You have not Published Any Post Yet</div>";
}
