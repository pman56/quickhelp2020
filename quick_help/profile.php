...
if (in_array($up, range($min1, $max1), true)) {
   echo "<b style='font-size:20px;color:<?php echo $color6; ?>'> Helper Level: 1</b><br>";
}
...
if (in_array($up, range($min2, $max2), true)) {
   echo "<b style='font-size:20px;color:<?php echo $color6; ?>'> Helper Level: 2</b><br>";
}
...
<b style='font-size:20px;color:<?php echo $color6; ?>'> Helper Level: <?php echo htmlentities(htmlentities($levels, ENT_QUOTES, "UTF-8")); ?></b><br>
<b style='font-size:20px;color:<?php echo $color6; ?>'> This Member has : <?php //echo $st_count; ?> Posts</b><br>


<b style='font-size:16px;'> Member Since:</b> <span data-livestamp='<?php echo $created_time; ?>'></span><br>
<div style='background:<?php echo $color6; ?>;color:white;padding:10px;border-radius:20%;font-size:16px;'><i  style='font-size:20px;' class='fa fa-check'></i> User Verified</div>
</div>
...
<h4><center>Members Posts List</center></h4>
...
if($total_count == 0){
echo "<div style='background:red;color:white;padding:10px;'>This User has not Published Any Post Yet</div>";
}
